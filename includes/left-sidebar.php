...
<aside id="leftSidebar" class="left-sidebar" data-collapsed="false">
    ...
    <div class="sb-panel">
        ...
        <div class="sb-pane" id="pane-leaderboard">
            <div class="sb-pane-header">
                <span class="text-white text-xs font-semibold">Leaderboard</span>
                <span class="online-badge" style="color:#f59e0b;background:rgba(245,158,11,0.1);border-color:rgba(245,158,11,0.2);">Top Players</span>
            </div>
            <div id="sb-leaderboard" class="friends-list" style="padding:0 8px 8px;">
